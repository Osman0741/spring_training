...
//    }
    ...
    public void afterReturningGetMappingOperation(JoinPoint joinPoint, RuntimeException exception) {
        logger.error("After Throwing -> Method: {}, Result: {}", joinPoint.getSignature().toShortString(), exception.getMessage());
    }
